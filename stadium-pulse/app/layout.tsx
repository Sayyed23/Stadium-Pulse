...
export const metadata: Metadata = {
  ...
  description: "GenAI-Enabled Stadium Operations & Tournament Experience Platform",
};
  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col font-sans bg-[#101415] text-[#e0e3e5]">
        <a href="#main-content" className="sr-only focus-visible:not-sr-only focus-visible:absolute focus-visible:z-50 focus-visible:p-4 focus-visible:bg-[#1d2022] focus-visible:text-[#00f2ff]">
