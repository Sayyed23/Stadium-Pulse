    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
        <div className="aspect-[16/9] bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 flex items-center justify-center relative">
          ...
          <div className="absolute top-8 right-8 px-3 py-1.5 rounded-lg bg-slate-500/20 text-xs font-semibold text-slate-400">
            Zone A
          </div>
          <div className="absolute bottom-8 left-8 px-3 py-1.5 rounded-lg bg-slate-500/20 text-xs font-semibold text-slate-400">
            Zone C
          </div>
          <div className="absolute bottom-8 right-8 px-3 py-1.5 rounded-lg bg-slate-500/20 text-xs font-semibold text-slate-400">
            Zone D
          </div>
          <div className="text-center">
            ...
            <p className="text-xs text-slate-400 mt-1">
              Your assigned zones are highlighted
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
        <div className="px-5 py-3 border-b border-zinc-200 dark:border-zinc-800">
          <h3 className="font-semibold text-sm flex items-center gap-2">
            <MapPin size={16} className="text-teal-500" /> Quick Routes
          </h3>
        </div>
        <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
          {[
            ...
            <div
              key={route.to}
              className="px-5 py-3.5 hover:bg-zinc-50 dark:hover:bg-zinc-800/30 transition-colors cursor-pointer flex items-center justify-between"
            >
              <div>
