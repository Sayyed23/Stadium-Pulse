...
const threads = [
  {
    ...
    lastMsg: "New assignment: Gate 3 wheelchair assist",
    time: "2m",
    unread: 2,
  },
  {
    id: "team-b",
    name: "Team B — Zone B",
    lastMsg: "All clear on south concourse",
    time: "8m",
    unread: 0,
  },
  {
    ...
    lastMsg: "Zone B alert acknowledged, monitoring.",
    time: "15m",
    unread: 0,
  },
];
...
const messages = [
  {
    from: "dispatch",
    text: "Incident INC-042: Medical emergency at Zone B. You have been assigned.",
    time: "16:12",
    self: false,
  },
  {
    from: "you",
    text: "Acknowledged. Heading to Zone B concourse now.",
    time: "16:13",
    self: true,
  },
  {
    from: "dispatch",
    text: "First aid kit location: Cabinet #4, near Gate 5.",
    time: "16:13",
    self: false,
  },
  ...
  {
    from: "dispatch",
    text: "New assignment: Assist wheelchair guest — Gate 3",
    time: "16:28",
    self: false,
  },
];
          ...
          {threads.map((t) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                {t.unread > 0 && (
                  <span className="w-5 h-5 rounded-full bg-teal-500 text-white text-[10px] flex items-center justify-center font-bold shrink-0">
                    {t.unread}
                  </span>
                )}
              </div>
          ...
          {messages.map((msg) => (
            ...
            >
              ...
              >
                <p>{msg.text}</p>
                <p
                  className={`text-[10px] mt-1 ${msg.self ? "text-teal-200" : "text-zinc-400"}`}
                >
                  {msg.time}
                </p>
              </div>
