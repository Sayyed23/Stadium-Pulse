...
const events = [
  {
    id: "e1",
    name: "Cricket World Cup — Semi-Final",
    date: "2026-07-20",
  ...
  {
    id: "e2",
    name: "Cricket World Cup — Quarter-Final 1",
    date: "2026-07-18",
    venue: "Mumbai Cricket Stadium",
    status: "live",
    gates: "14:00",
  ...
  {
    id: "e3",
    name: "Cricket World Cup — Quarter-Final 2",
    date: "2026-07-17",
    venue: "Mumbai Cricket Stadium",
    status: "completed",
    gates: "14:00",
            ...
            {events.map((e) => (
              ...
              >
                ...
                <td className="py-3 px-5">
                  <span
                    className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase ${statusColors[e.status]}`}
                  >
                    {e.status}
                  </span>
                </td>
