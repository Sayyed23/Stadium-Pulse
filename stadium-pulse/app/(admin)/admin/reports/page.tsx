...
const reports = [
  ...
  { id: "rep2", name: "Incident SLA & Response Performance", dateRange: "Last 7 Days", type: "PDF" },
  { id: "rep3", name: "Grounding Hallucination & Query Log Audit", dateRange: "Last 30 Days", type: "CSV" },
  { id: "rep4", name: "Sustainability & Transport Operations Metrics", dateRange: "Tournament Total", type: "PDF / CSV" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {reports.map((r) => (
          <div key={r.id} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 flex items-center justify-between">
            <div>
