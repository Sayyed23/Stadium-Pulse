        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
            {languages.map((l) => (
              ...
              >
                <td className="py-3 px-5 text-sm font-mono uppercase font-bold text-violet-400">
                  {l.code}
                </td>
                ...
                <td className="py-3 px-5">
                  {l.isDefault ? (
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-violet-500/10 text-violet-400 uppercase">
                      Default
                    </span>
                  ) : (
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 uppercase">
                      Active
                    </span>
                  )}
                </td>
