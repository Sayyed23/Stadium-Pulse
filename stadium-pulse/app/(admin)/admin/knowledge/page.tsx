...
const articles = [
  {
    id: "kb1",
    title: "Wheelchair Accessible Entrance Locations",
    category: "Navigation",
    tags: ["accessibility", "gates"],
  ...
  {
    id: "kb3",
    title: "Food & Beverage Pricing & Outlets",
    category: "Amenities",
    tags: ["food", "prices"],
  ...
  {
    id: "kb4",
    title: "Shuttle Service Frequency & Timings",
    category: "Transport",
    tags: ["shuttle", "parking"],
                ...
                <td className="py-3 px-5">
                  <div className="flex gap-1">
                    {art.tags.map((t) => (
                      <span
                        key={t}
                        className="text-[10px] bg-violet-500/10 text-violet-400 px-2 py-0.5 rounded-full flex items-center gap-0.5"
                      >
                        <Tag size={10} /> {t}
                      </span>
                    ))}
