  ...
  return (
    <main className="relative min-h-screen bg-[#101415] text-[#e0e3e5] font-sans overflow-x-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div
          className="w-full h-[85vh] bg-cover bg-center opacity-30"
          style={{
            backgroundImage:
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#101415]/80 backdrop-blur-xl border-b border-[#3a494b]/30">
        <div className="flex justify-between items-center w-full px-6 max-w-7xl mx-auto py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl text-[#00f2ff] tracking-tight">
              StadiumPulse AI
            </span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#1d2022] border border-[#3a494b]/50 text-xs">
              ...
              >
                <option value="EN" className="bg-[#101415]">
                  EN - English
                </option>
                <option value="HI" className="bg-[#101415]">
                  HI - हिन्दी
                </option>
                <option value="ES" className="bg-[#101415]">
                  ES - Español
                </option>
                <option value="FR" className="bg-[#101415]">
                  FR - Français
                </option>
              </select>
            </div>
            ...
            <Link
              href="/login"
              className="px-4 py-2 rounded-xl bg-[#00f2ff] text-[#00363a] font-bold text-xs hover:bg-[#74f5ff] transition-all shadow-[0_0_15px_rgba(0,242,255,0.3)]"
            >
              Staff Login
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-lg text-[#b9cacb] max-w-xl leading-relaxed">
              Real-time turn-by-turn navigation, live crowd telemetry, emergency
              SOS dispatch, and AI copilot insights for FIFA World Cup 2026™.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4">
              ...
              >
                ...
                <div>
                  <div className="font-bold text-sm text-white group-hover:text-[#00f2ff] transition-colors">
                    Fan Experience
                  </div>
              ...
              >
                ...
                <div>
                  <div className="font-bold text-sm text-white group-hover:text-[#5cf968] transition-colors">
                    Volunteer Portal
                  </div>
                  <div className="text-[11px] text-[#b9cacb]">
                    Tasks & Copilot
            ...
            <div className="p-6 rounded-3xl bg-[#1d2022]/80 backdrop-blur-xl border border-[#3a494b]/50 shadow-2xl space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-[#b9cacb] mt-1">
                  Azteca Stadium · Sector A, B, C & D Active
                </p>
              </div>

              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="p-3 rounded-xl bg-[#272a2c] border border-[#3a494b]/30 text-xs">
                  <span className="text-[#b9cacb] block text-[10px]">
                    AVG NAV TIME
                  </span>
                  <span className="text-[#00f2ff] font-bold text-base font-mono">
                    4.2 Mins
                  </span>
                </div>
                <div className="p-3 rounded-xl bg-[#272a2c] border border-[#3a494b]/30 text-xs">
                  ...
                  <span className="text-[#5cf968] font-bold text-base font-mono">
                    98.4% Resolv
                  </span>
                </div>
              </div>
              ...
              <div className="pt-2">
                <Link
                  href="/fan"
                  className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#00f2ff] text-[#00363a] font-bold text-sm hover:bg-[#74f5ff] transition-all"
                >
      ...
      <footer className="w-full border-t border-[#3a494b]/30 py-8 text-center text-xs text-[#b9cacb] flex flex-wrap justify-center gap-6">
        <Link href="/about" className="hover:text-[#00f2ff] transition-colors">
          About
        </Link>
        <Link href="/faq" className="hover:text-[#00f2ff] transition-colors">
          FAQ
        </Link>
        <Link href="/help" className="hover:text-[#00f2ff] transition-colors">
          Help Center
        </Link>
        <Link
          href="/privacy"
        ...
        <Link href="/terms" className="hover:text-[#00f2ff] transition-colors">
          Terms of Service
        </Link>
        <Link
          href="/contact"
