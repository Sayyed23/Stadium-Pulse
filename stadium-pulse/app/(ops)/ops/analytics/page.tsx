  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button type="button" className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium transition-colors">
          <FileDown size={16} />
          Export Report
        </button>
      </div>
          ...
          {[20, 35, 45, 52, 61, 72, 80, 91, 88, 78, 65, 55, 48, 40].map((v, i) => {
            ...
            return (
              <div key={`chart-col-${i}`} className="flex-1 flex flex-col items-center gap-1">
                <div className={`w-full rounded-t transition-all ${bgClass}`} style={{ height: `${v * 1.5}px` }} />
