...
const aiReports = [
  {
    title: "Zone B Crowd Surge Analysis",
    time: "16:20",
    summary:
      "Identified pattern of rapid ingress through Gate 3. Recommend temporary diversion.",
  },
  {
    title: "Half-Time Prediction Model",
    time: "15:45",
    summary:
      "Expected 30% increase in concourse traffic. Food courts will reach 90% capacity.",
  },
  {
    title: "Transport Load Forecast",
    time: "14:30",
    summary:
      "Parking A expected to reach capacity by 17:00. Shuttle demand will peak at full-time.",
  },
];
    ...
    <div className="space-y-6">
      ...
      <section>
        <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
          <Users size={18} className="text-blue-500" /> Crowd Analytics
        </h3>
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5">
        <h3 className="font-semibold mb-4 flex items-center gap-2">
          <BarChart3 size={16} /> Hourly Occupancy
        </h3>
        <div className="h-40 flex items-end gap-1.5">
          {[20, 35, 45, 52, 61, 72, 80, 91, 88, 78, 65, 55, 48, 40].map(
            (v, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-full rounded-t transition-all ${bgClass}`}
      ...
      <section>
        <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
          <AlertTriangle size={18} className="text-amber-500" /> Incident
          Analytics
        </h3>
      ...
      <section>
        <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
          <Bot size={18} className="text-purple-500" /> AI Reports
        </h3>
        <div className="space-y-3">
          {aiReports.map((r) => (
            <div
              key={r.title}
              className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 hover:shadow-md transition-shadow cursor-pointer"
            >
