    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
        <h3 className="font-semibold text-lg mb-4 flex items-center gap-2">
          <Activity size={18} className="text-blue-500" /> Alert Thresholds
        </h3>
        <div className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              <label htmlFor="warning-slider" className="text-sm font-medium">
                Warning Threshold
              </label>
              <span
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label htmlFor="critical-slider" className="text-sm font-medium">
                Critical Threshold
              </label>
              <span
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label htmlFor="cooldown-slider" className="text-sm font-medium">
                Anti-Spam Cooldown
              </label>
            ...
            <input
              ...
              aria-label="Anti-Spam Cooldown in Seconds"
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xs text-zinc-400">
                Browser push for threshold alerts
              </div>
            </div>
            <ToggleButton
              value={pushEnabled}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xs text-zinc-400">
                Daily summary and critical alerts
              </div>
            </div>
            <ToggleButton
              value={emailEnabled}
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
        <h3 className="font-semibold text-lg mb-4 flex items-center gap-2">
          <Settings size={18} className="text-slate-400" /> System
        </h3>
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between py-2 border-b border-zinc-100 dark:border-zinc-800">
            <span className="text-zinc-500">SSE Status</span>
