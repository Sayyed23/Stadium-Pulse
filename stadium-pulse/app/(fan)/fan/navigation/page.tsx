...
const routeSteps = [
  {
    instruction: "Head north from your current position",
    distance: "30m",
    zone: "Zone B",
  },
  {
    instruction: "Turn left at the concourse junction",
    distance: "50m",
    zone: "Zone B",
  },
  {
    instruction: "Continue straight past Gate 5",
    distance: "80m",
    zone: "Zone A",
  },
  {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-28 md:pb-12 font-sans space-y-6">
      ...
      <div className="bg-[#1d2022] border border-[#3a494b]/40 p-5 rounded-2xl shadow-xl">
        <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">
          Indoor Turn-by-Turn Wayfinding
        </h2>
        <p className="text-xs sm:text-sm text-[#b9cacb] font-mono mt-1">
          Navigate seamlessly inside Azteca Stadium with live BLE indoor
          positioning
        </p>
      </div>
          ...
          <div className="bg-[#1d2022] border border-[#00f2ff]/30 rounded-2xl p-5 space-y-4 shadow-xl">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  className="w-10 h-10 rounded-xl bg-[#101415] border border-[#3a494b] flex items-center justify-center hover:border-[#00f2ff] transition-colors"
                >
            ...
            >
              <div
                className={`w-9 h-5 rounded-full transition-colors relative ${accessibleOnly ? "bg-[#00f2ff]" : "bg-[#3a494b]"}`}
              >
                <div
                  className={`absolute top-0.5 w-4 h-4 bg-[#101415] rounded-full shadow transition-transform ${accessibleOnly ? "translate-x-4" : "translate-x-0.5"}`}
                />
              </div>
              <Accessibility
                size={16}
                className={accessibleOnly ? "text-[#00f2ff]" : "text-[#b9cacb]"}
              />
              <span className="text-xs text-[#e0e3e5]">
                Accessible elevator routes only
              </span>
            </button>
          ...
          {showRoute && (
            <div className="bg-[#1d2022] border border-[#00f2ff]/30 rounded-2xl p-5 space-y-4 animate-slide-up shadow-xl">
              <div className="flex items-center justify-between border-b border-[#3a494b]/30 pb-3">
                <h3 className="text-xs font-mono font-bold text-[#00f2ff] uppercase tracking-wider">
                  ...
                  >
                    ...
                    <div className="pt-0.5">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-[11px] text-[#00f2ff] font-mono font-bold">
                          {step.distance}
                        </span>
            ...
            <div className="aspect-[16/10] bg-gradient-to-br from-[#101415] to-[#272a2c] flex items-center justify-center relative p-4">
              <div className="absolute inset-4 border border-dashed border-[#00f2ff]/30 rounded-xl flex items-center justify-center">
                <div className="text-center p-4">
                  <MapPin
                    size={36}
                    className="text-[#00f2ff] mx-auto mb-2 animate-bounce"
                  />
                  <p className="text-xs font-bold text-white">
                    Indoor Positioning Signal Active
                  </p>
                  <p className="text-[11px] text-[#b9cacb] font-mono mt-1">
                    Azteca Level 3 Concourse · Gate 12 Proximity
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="bg-[#1d2022] border border-[#3a494b]/40 rounded-2xl p-5 space-y-3 shadow-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {nearbyPlaces.map((place) => (
                <div
                  key={place.name}
                  className="bg-[#101415] border border-[#3a494b]/40 rounded-xl p-3.5 flex items-center justify-between hover:border-[#00f2ff]/40 transition-all cursor-pointer"
                >
                  <div>
