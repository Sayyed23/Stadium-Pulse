  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] w-full relative font-sans">
      <div className="absolute z-10 p-4 sm:p-6 w-full bg-gradient-to-b from-[#101415]/80 to-transparent pointer-events-none">
        <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Interactive Stadium Map & Wayfinding</h2>
        <p className="text-xs text-[#b9cacb] font-mono mt-0.5">Real-time facility telemetry & guided route layers</p>
      </div>
      ...
      {loadError ? (
        <div className="flex items-center justify-center h-full bg-[#101415]">
          <p className="text-red-400 font-mono text-sm">Interactive map engine loading fallback view...</p>
        </div>
      ) : isLoaded ? (
        <GoogleMap
        ...
        <div className="flex items-center justify-center h-full bg-[#101415]">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-[#00f2ff] font-mono text-xs tracking-wider">LOADING STADIUM MAP TELEMETRY...</p>
          </div>
        </div>
      )}
      ...
      >
        <h3 className="text-xs font-mono font-bold text-[#00f2ff] mb-3 uppercase tracking-wider">Select Guided Route</h3>
