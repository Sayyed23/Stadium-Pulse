    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-28 md:pb-12 font-sans space-y-6">
      ...
      <div className="bg-[#1d2022] border border-[#3a494b]/40 p-5 rounded-2xl shadow-xl">
        ...
        <p className="text-xs sm:text-sm text-[#b9cacb] font-mono mt-1">
          Instant 1-Tap geolocation dispatch to Control Room & Security Desk
        </p>
      </div>
      ...
      <button
        type="button"
        className="relative w-full py-9 rounded-3xl bg-gradient-to-br from-red-600 via-red-700 to-red-900 text-white font-extrabold text-2xl tracking-wider flex flex-col items-center justify-center gap-2 shadow-[0_0_35px_rgba(239,68,68,0.4)] border border-red-500/50 hover:scale-[1.02] transition-all active:scale-95 overflow-hidden group"
      >
        <div className="flex items-center gap-3">
          <ShieldAlert size={34} className="animate-bounce text-white" />
          <span>1-TAP EMERGENCY SOS</span>
        </div>
        <span className="text-xs font-mono text-red-200 font-normal">
          Broadcasts live GPS coordinates to Command Desk
        </span>
      </button>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          type="button"
          className="bg-[#1d2022] border border-red-500/30 rounded-2xl p-5 flex flex-col items-center gap-3 hover:border-red-500 transition-all cursor-pointer"
        >
          ...
          <div className="text-center">
            ...
            <div className="text-[10px] text-[#b9cacb] mt-0.5">
              Paramedic dispatch
            </div>
          </div>
        </button>
        ...
        <button
          type="button"
          className="bg-[#1d2022] border border-[#00f2ff]/30 rounded-2xl p-5 flex flex-col items-center gap-3 hover:border-[#00f2ff] transition-all cursor-pointer"
        >
        ...
        <button
          type="button"
          className="bg-[#1d2022] border border-amber-500/30 rounded-2xl p-5 flex flex-col items-center gap-3 hover:border-amber-500 transition-all cursor-pointer"
        >
        ...
        <button
          type="button"
          className="bg-[#1d2022] border border-purple-500/30 rounded-2xl p-5 flex flex-col items-center gap-3 hover:border-purple-500 transition-all cursor-pointer"
        >
          ...
          {emergencyContacts.map((contact) => (
            ...
            >
              <div>
                ...
                <div className="text-[10px] text-[#b9cacb] font-mono">
                  {contact.available}
                </div>
              </div>
