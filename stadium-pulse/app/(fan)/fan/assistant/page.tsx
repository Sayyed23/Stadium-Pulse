...
export default function AssistantPage() {
  return (
    <div className="flex flex-col h-full p-4 md:p-8 max-w-4xl mx-auto w-full relative font-sans">
      <Link
        href="/fan"
        className="inline-flex items-center gap-1.5 text-xs font-mono font-bold text-[#00f2ff] hover:underline mb-3"
      >
      ...
      <div className="mb-6">
        ...
        <p className="text-[#b9cacb] font-mono text-xs">
          Ask a question in English, Hindi, Marathi, Arabic, French, or Spanish
          for grounded venue guidance.
        </p>
      </div>
