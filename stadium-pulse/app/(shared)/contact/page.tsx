    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div>
        ...
        <p className="text-sm text-slate-400">
          Reach out to the StadiumPulse AI operations team
        </p>
      </div>
      ...
      >
        ...
        <div>
          ...
          <input
            id="contact-subject"
            type="text"
            placeholder="e.g. Lost item query, Feedback"
            className="w-full bg-slate-100 dark:bg-slate-800 rounded-xl px-4 py-2 text-sm border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        <div>
          <label
          ...
          <textarea
            ...
            className="w-full bg-slate-100 dark:bg-slate-800 rounded-xl p-4 text-sm border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
          />
        </div>
        <button
          type="submit"
