  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {[
          {
            title: "Match Kickoff in 30 minutes",
            desc: "Please reach your assigned seats in Zone A / Zone B.",
            time: "15m ago",
          },
          {
            title: "Weather Update",
            desc: "Clear skies expected throughout the match duration.",
            time: "1h ago",
          },
          {
            title: "Gate 5 Access Opened",
            desc: "Additional turnstiles operational at Gate 5 for faster entry.",
            time: "2h ago",
          },
        ].map((item) => (
          <div
